...
export const registerUser = async (req, res, next) => {
    ...
    const user = await User.create({
        ...
        avatar: {
            public_id: "public_id",
            url: "https://res.cloudinary.com/dzcmadjl1/image/upload/v1690794417/default-avatar_ajh8lq.png",
        },
    });
...
export const forgetPassword = async (req, res, next) => {
    ...
    try {
        ...
        console.error("Forgot password save error:", error);
...
`;
    ...
    try {
        await sendMailer({ email: user.email, subject: "Password Reset Request", text: message, htmlMessage: htmlMessage });
        res.status(200).json({
            success: true,
