    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className={`px-7 py-3 rounded-3xl font-semibold text-lg shadow-sm ${
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              ...
              <motion.p
                ...
                className={`mt-8 text-center text-lg font-medium ${
                  order.orderStatus === "Cancelled" ? "text-red-600" : "text-gray-700"
                }`}
              >
            ...
            >
              ...
              <div className="text-gray-700 text-[17px] leading-relaxed space-y-1">
                ...
                <p className="pt-4 font-medium">📱 {order.shippingAddress.phoneNo}</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-6">
                {order.orderItems.map((item, index) => (
                  <div key={index} className="flex gap-6 bg-gray-50 rounded-2xl p-6">
                    <img
                      src={item.image}
                      alt={item.name}
          ...
          <div className="lg:col-span-4">
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sticky top-8"
            >
